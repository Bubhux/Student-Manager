...
class MainMenuView:
    ...
    def display_main_menu(self):
        ...
        while True:
            ...
            if choice_menu == "1":
                ...
                print("Choix invalide, saisissez un nombre entre 1 et 8.")
    ...
    def add_student(self):
        ...
        # Valide les données d'entrée en appelant validate_input_data
        if student.validate_input_data():
            student_data = {
    ...
    def update_student_grades(self):
        ...
        # Valide les nouvelles notes en appelant validate_input_data
        if updated_student.validate_input_data():
